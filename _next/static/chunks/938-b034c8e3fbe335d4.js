      ...
      let v = l.forwardRef((e, t) => {
              ...
              l.default.createElement(
                ...
                Object.assign({}, j, r, {
                  ...
                  ref: l.useCallback(
                    (e) => {
                      t &&
                        ('function' == typeof t ? t(e) : 'object' == typeof t && (t.current = e)),
                        e && (C && (e.src = e.src), e.complete && p(e, v, E, S, w))
                    },
                    [v, E, S, C, w, t]
                  ),
                  onLoad(e) {
        ...
        b = l.forwardRef((e, t) => {
          ...
          if ('object' == typeof (n = p) && (h(n) || void 0 !== n.src)) {
            ...
            if (
              ((r = H.blurWidth), (o = H.blurHeight), (O = O || H.blurDataURL), (U = H.src), !z)
            ) {
              if (V || J) {
                if (V && !J) {
                  let $ = V / H.width
          ...
          ;((p = 'string' == typeof p ? p : U).startsWith('data:') || p.startsWith('blob:')) &&
            ((w = !0), (Q = !1)),
            W.unoptimized && (w = !0)
          let X = m(_),
            Y = Object.assign(
            ...
            et = (function (e) {
              ...
              let { widths: s, kind: c } = (function (e, t, r) {
                  ...
                  if (r) {
                    ...
                    if (a.length) {
                      ...
                      return { widths: o.filter((e) => e >= i[0] * s), kind: 'w' }
                    }
              ...
              return {
                ...
                srcSet: s
                  .map((e, i) =>
                    ''
                      .concat(l({ config: t, src: r, quality: n, width: e }), ' ')
                      .concat('w' === c ? e : i + 1)
                      .concat(c)
                  )
                  .join(', '),
            ...
            })({ config: W, src: p, unoptimized: w, width: V, quality: X, sizes: b, loader: T }),
            er = p,
            ei = { imageSrcSet: et.srcSet, imageSizes: et.sizes, crossOrigin: F.crossOrigin },
            eo = l.useRef(x)
          l.useEffect(() => {
            eo.current = x
          }, [x])
    ...
    2675: function (e, t) {
      ...
      Object.defineProperty(t, '__esModule', { value: !0 }),
        (t.getImageBlurSvg = function (e) {
          let { widthInt: t, heightInt: r, blurWidth: i, blurHeight: o, blurDataURL: n } = e,
            a = i || t,
            l = o || r,
