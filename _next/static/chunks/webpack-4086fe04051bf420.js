!(function () {
  ...
  function f(e) {
    ...
    var r = (c[e] = { exports: {} }),
      n = !0
    try {
      a[e].call(r.exports, r, r.exports, f), (n = !1)
    } finally {
      n && delete c[e]
    }
    return r.exports
  ...
  ;(f.m = a),
    ...
    (f.O = function (t, r, n, o) {
      ...
      for (var i = 1 / 0, u = 0; u < e.length; u++) {
        for (var r = e[u][0], n = e[u][1], o = e[u][2], a = !0, c = 0; c < r.length; c++)
          i >= o &&
    ...
    (f.u = function (e) {
      return (
        ...
        '.' +
        {
          257: '5bf7dc31cb3b22d1',
          367: 'eef3fd0aab4c4e09',
          732: '1c0b735ab01787b8',
          806: '824546c3f11ac143',
        }[e] +
        '.js'
      )
    }),
    (f.miniCssF = function (e) {
      return 'static/css/d47ff6d3a5adb5ac.css'
    }),
    (f.o = function (e, t) {
    ...
    (f.l = function (e, n, o, u) {
      ...
      if (void 0 !== o)
        for (var i, a, c = document.getElementsByTagName('script'), l = 0; l < c.length; l++) {
          var s = c[l]
    ...
    (u = function (e, t) {
      ...
      for (e && e(t); c < u.length; c++) (n = u[c]), f.o(o, n) && o[n] && o[n][0](), (o[n] = 0)
      return f.O(l)
    }),
